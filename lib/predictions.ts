  ...
  return {
    ...
    inputSnapshot: {
      home: {
        ...
        shToiPercentile: homeInputs.shToiPercentile,
        skaters: homeInputs.skaters.map(s => ({
          playerId: s.playerId,
          playerName: s.playerName,
          position: s.positionCode,
          compositePpm: s.composite.ppm,
          momentumPpm: s.momentum.ppm,
          seasonPpm: s.season.ppm,
          careerPpm: s.career.ppm,
          energyBar: s.energyBar,
          injuryStatus: s.injuryStatus ?? null,
        })),
        goalie: {
          playerId: homeInputs.goalie.playerId,
          playerName: homeInputs.goalie.playerName,
          momentumShotsPerGoal: homeInputs.goalie.momentum.shotsPerGoal,
          seasonShotsPerGoal: homeInputs.goalie.season.shotsPerGoal,
          momentumSavePct: homeInputs.goalie.momentum.savePct,
          seasonSavePct: homeInputs.goalie.season.savePct,
        },
      },
      away: {
        energyBar: awayInputs.energyBar,
        sosMultiplier: awayInputs.sosMultiplier,
        shToiPercentile: awayInputs.shToiPercentile,
        skaters: awayInputs.skaters.map(s => ({
          playerId: s.playerId,
          playerName: s.playerName,
          position: s.positionCode,
          compositePpm: s.composite.ppm,
        ...
        goalie: {
          playerId: awayInputs.goalie.playerId,
          playerName: awayInputs.goalie.playerName,
          momentumShotsPerGoal: awayInputs.goalie.momentum.shotsPerGoal,
          seasonShotsPerGoal: awayInputs.goalie.season.shotsPerGoal,
          momentumSavePct: awayInputs.goalie.momentum.savePct,
          seasonSavePct: awayInputs.goalie.season.savePct,
        },
      },
    },
  };
